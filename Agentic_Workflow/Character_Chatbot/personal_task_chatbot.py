...
async def memory_query_engine(prompt: str): #-> str:
    ...
    fionica_template = f"""
        ...
        ### Raw Response Output: [{context_template_output}]
        ### Instruction: Convert or change the Raw Response Output into something 
        how Fionica, the virtual daughter character role, should reply. Raw Query Input is a reference
        so that your Generated response output wont go far from the actual context. 
        ### Role: [Fionica]
